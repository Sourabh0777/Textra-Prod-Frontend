      ...
      <CardContent className="prose prose-neutral max-w-none">
        <section className="mb-8">
          ...
          <p className="text-neutral-600 leading-relaxed">
            ...
            communicate with us. This may include your name, email address, business details, and customer information.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-neutral-600 leading-relaxed">
            ...
            consent. We may share information with service providers who perform services on our behalf.
          </p>
        </section>
