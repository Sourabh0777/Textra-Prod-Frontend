...
export default function OpticalPrescriptionsList() {
            ...
            <Table>
              <TableHead className="bg-slate-50/50">
                <TableRow>
                  ...
                  <TableHeaderCell className="font-bold text-slate-600">Lens Type</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Right Eye</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Left Eye</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Created</TableHeaderCell>
