...
export default function OpticalCustomerDetailPage() {
        ...
        <Card className="border border-slate-100 shadow-sm rounded-2xl bg-white p-6">
          ...
          <Table>
            <TableHead className="bg-slate-50/50">
              <TableRow>
                <TableHeaderCell className="font-bold text-slate-600">Type</TableHeaderCell>
                <TableHeaderCell className="font-bold text-slate-600">Reference</TableHeaderCell>
                <TableHeaderCell className="font-bold text-slate-600">Amount</TableHeaderCell>
