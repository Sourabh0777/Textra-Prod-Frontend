          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHead className="bg-slate-50/50">
                <TableRow>
                  <TableHeaderCell className="font-bold text-slate-600">Order Type</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Patient</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Product</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Price</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Quantity</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Order Date</TableHeaderCell>
