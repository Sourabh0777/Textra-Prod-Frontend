          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHead className="bg-slate-50/50">
                <TableRow>
                  <TableHeaderCell className="font-bold text-slate-600">Invoice</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Patient</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Total</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Paid</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Status</TableHeaderCell>
                  <TableHeaderCell className="font-bold text-slate-600">Date</TableHeaderCell>
