                            ...
                            <Table>
                              <TableHead className="bg-neutral-100/50">
                                <TableRow>
                                  ...
                                  <TableHeaderCell className="py-2">Variants Config</TableHeaderCell>
            ...
            <TableRow>
              <TableCell colSpan={4} className="text-center py-12 text-neutral-500">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <p className="text-sm">Get started by adding your first car brand.</p>
                </div>
              </TableCell>
            </TableRow>
          )}
