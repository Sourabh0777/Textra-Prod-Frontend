...
import { useSubAdminCustomersPage } from '@/lib/hooks/use-sub-admin-customers-page';
...
export default function SubAdminCustomersPage() {
  ...
  if (loading) {
    return (
      <>
        <Header title="Sub-Admin Customers" subtitle="Manage customers across all businesses" />
      ...
      <div className="p-4 md:p-8">
        ...
        <Card>
          <CardBody className="!p-0">
            <SubAdminCustomerTable customers={filteredCustomers} onEdit={handleOpenModal} onDelete={handleDelete} />
          </CardBody>
        </Card>
      </div>
