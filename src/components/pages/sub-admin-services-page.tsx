...
import { useSubAdminServicesPage } from '@/lib/hooks/use-sub-admin-services-page';
import { ServiceTable } from '@/components/services/service-table';
import { ServiceModal } from '@/components/services/service-modal';
import { RefreshCw } from 'lucide-react';

export default function SubAdminServicesPage() {
  const {
    services,
    filteredServices,
    vehicles,
  ...
  if (loading) {
    return (
      <>
        <Header title="Sub-Admin Services" subtitle="Manage services across all businesses" />
