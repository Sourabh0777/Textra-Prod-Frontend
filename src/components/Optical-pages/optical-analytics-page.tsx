            ...
            <Table>
              <thead>
                <TableRow className="bg-slate-50/50">
                  <th className="px-6 py-3 text-left font-bold text-slate-600">Metric</th>
                  <th className="px-6 py-3 text-left font-bold text-slate-600">Value</th>
                </TableRow>
              </thead>
              <TableBody>
                <TableRow>
            ...
            <Table>
              <thead>
                <TableRow className="bg-slate-50/50">
                  ...
                  <th className="px-6 py-3 text-left font-bold text-slate-600">Orders</th>
                  <th className="px-6 py-3 text-left font-bold text-slate-600">Revenue</th>
                </TableRow>
              </thead>
              <TableBody>
                {(topItems ?? []).length > 0 ? (
