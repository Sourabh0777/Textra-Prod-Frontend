...
interface OpticalBillDetailsPageProps {
  billId: string;
  onRefresh?: () => void;
}

export default function OpticalBillDetailsPage({ billId, onRefresh }: OpticalBillDetailsPageProps) {
  const { data: bill, isLoading, refetch } = useFetchBillQuery(billId);
