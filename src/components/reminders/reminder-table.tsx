...
export function ReminderTable({
  ...
  const statusOptions = [
    ...
    { label: '7 Days Before', value: ReminderStatus.BEFORE_7_DAYS },
    { label: '2 Days Before', value: ReminderStatus.BEFORE_2_DAYS },
    { label: 'On Due Date', value: ReminderStatus.ON_DUE_DATE },
    { label: '3 Days After', value: ReminderStatus.AFTER_3_DAYS },
    { label: '10 Days After', value: ReminderStatus.AFTER_10_DAYS },
    { label: '30 Days After', value: ReminderStatus.AFTER_30_DAYS },
    { label: 'Lost', value: ReminderStatus.LOST_SERVICE_CYCLE },
    { label: 'Completed', value: ReminderStatus.COMPLETED },
  ];

  const filteredReminders = useMemo(() => {
    if (selectedStatus === 'all') return reminders;
    return reminders.filter((r) => r.status === selectedStatus);
  ...
  return (
    <div className="w-full space-y-4">
      {/* Status Filter Tabs */}
      <div className="bg-white p-1 rounded-xl border border-neutral-200 shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 px-3 py-2 border-b border-neutral-100 bg-neutral-50/50">
          <Filter className="w-4 h-4 text-neutral-500" />
          <span className="text-sm font-semibold text-neutral-700">Filter by Status</span>
        ...
        <div className="flex overflow-x-auto no-scrollbar p-2 gap-2 bg-white">
              ...
              >
                <div className="p-4 bg-neutral-50 border-b border-neutral-200 flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <Link
                        href={`/customer-details/${customer?._id}`}
